...
export default function AddBookingDialog({ open, onOpenChange, formData, handleFormChange, addPassenger, removePassenger, updatePassenger, addService, removeService, updateService, calculateTotal, handleAddBooking }) {
    const validateForm = () => {
        const errors = {};
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="min-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="text-xl font-bold">Tạo booking mới</DialogTitle>
                    <DialogDescription>Điền đầy đủ thông tin để tạo booking mới</DialogDescription>
                </DialogHeader>
