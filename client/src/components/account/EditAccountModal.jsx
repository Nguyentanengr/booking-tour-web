...
const EditAccountModal = ({ show, onClose, formData, onFormChange, onSubmit, activeTab, currentAccount }) => {
  if (!show) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="mb-4">
          <h3 className="text-xl font-bold">Chỉnh sửa {activeTab === "admins" ? "Quản trị viên" : activeTab === "users" ? "Người dùng" : "Hướng dẫn viên"}</h3>
